    ...
    <main className="profile-page">
      <section className="profile-hero" aria-labelledby="profile-title">
        <div className="profile-copy">
          <div className="profile-kicker">MYZUBSTER · IDENTITÀ DIGITALE</div>
          <h1 id="profile-title">Zubster <span aria-label="profilo verificato">✦</span></h1>
          <p className="profile-handle">@zubster · MyZubster ID: ZB-777</p>
          <p className="profile-tagline">Creo. Connetto. Vivo il Metaverso. ✨</p>

          <div className="profile-stats" aria-label="Statistiche profilo">
            <div><span>Livello</span><strong>18</strong></div>
            <div><span>Reputazione</span><strong>9.250</strong></div>
            <div><span>Follower</span><strong>4.2K</strong></div>
            <div><span>Spazi</span><strong>7</strong></div>
          </div>
          ...
          <section className="profile-about">
            ...
            <p>
              ...
              connessioni e progetti che lasciano il segno. Musica, arte, moda e tecnologia nel mio DNA.
            </p>
          </section>
        ...
        <div className="profile-art-wrap">
          ...
          />
          <div className="profile-art-badge">MYZUBSTER PROFILE · ONLINE</div>
        </div>
      </section>
    </main>
  );
